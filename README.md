...
♻️ Restore from the last backup
...
Запуск:
Просто скачай и запусти [https://github.com/Xcode24/sims4_cleaner/blob/main/sims4_cache_clean.bat](https://github.com/Xcode24/sims4_cleaner/blob/main/sims4_cache_clean.bat)
